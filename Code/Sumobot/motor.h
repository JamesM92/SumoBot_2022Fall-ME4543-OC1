...
*/
// define pins
#define PIN_MOTOR_STBY    A1 //4
#define PIN_MOTOR_AIN1    11 //3   // AO1 - RIGHT MOTOR  +
#define PIN_MOTOR_AIN2     3 //9   // AO2 - RIGHT MOTOR  -
#define PIN_MOTOR_BIN1    10 //10  // BO1 - LEFT MOTOR   +
#define PIN_MOTOR_BIN2     9 //11  // BO2 - LEFT MOTOR   -
