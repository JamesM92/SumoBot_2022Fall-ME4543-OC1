...
// ** BEGIN SETTINGS **
  ...
  #define DS_DIST_FAR      200 //(8*25)    // detect limit (should be diameter of arena = 770 mm (30.315 in))
...
void ds_report_values(void);
  ...
  #define PIN__XSHUT1   7   // DS_FC front center
  #define PIN__XSHUT2   8   // DS_FL front left
  #define PIN__XSHUT3   2   // DS_FR front right
  #define PIN__XSHUT4   12  // DS_SL side left
  #define PIN__XSHUT5   A3  // DS_SR side right
  #define PIN__XSHUT6   A2  // DS_BC back center
